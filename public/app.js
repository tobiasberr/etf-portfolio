...
function renderOverviewChart(agg) {
  ...
  // right (not bottom). A third of the viewport width, like the other
  // three pie charts.
  renderPieChart("chart-overview", "chartOverviewCanvas", "", items, {
    legendPosition: "right", widthPx: "33vw", heightPx: 500,
